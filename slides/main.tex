...
\begin{itemize}
	\item \textbf{Multiplayer..self-play} (Francis, 2019) has our task but uses PPO.
	\item \textbf{TD-MPC} (Hansen et al., 2022) has our method but uses continuous-control DMControl tasks.
\end{itemize}
\end{frame}
...
\begin{frame}{Project Schedule}
	\begin{itemize}
		\item Week 9: Snake environment implementation and training data.
		\item Week 10: Model implementation and training.
		\item Week 11: Model iteration and evaluation. 
		\item Week 12: Report writing and presentation preparation.
	\end{itemize}
\end{frame}

\begin{frame}{Task Distribution}
	\begin{itemize}
		\item Gregory: Project lead, report writing
		\item Celest: Training and evaluation
		\item Ryan: Model code implementation
		\item Yihe: Snake environment implementation
	\end{itemize}
\end{frame}
